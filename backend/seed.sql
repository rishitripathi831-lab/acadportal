-- AcadPortal Database Setup & Seed Script
-- Run this in MySQL Workbench or CLI to set up all tables and sample data

CREATE DATABASE IF NOT EXISTS acadportal_db;
USE acadportal_db;
...
-- Insert submissions (students have submitted some assignments)
...
-- Insert marks (student performance across subjects)
DELETE FROM marks;
